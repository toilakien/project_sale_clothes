...
const BannerUser = () => {
    const items = ['https://theme.hstatic.net/200000839719/1001200616/14/slide_1_img.jpg?v=212', 'https://theme.hstatic.net/200000839719/1001200616/14/slide_2_img.jpg?v=212'];
